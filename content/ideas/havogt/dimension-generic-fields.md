...
>
> Related: builds on [[ideas/havogt/dtype-generic-fields|Dtype-generic fields in gt4py.next]]
...
- **Scope**: extends the dtype-generics investigation
  ([[ideas/havogt/dtype-generic-fields|dtype-generic fields]]) to **dimensions**:
...
`pytest content/ideas/havogt/dimension-generic-fields/` and
`mypy --config-file content/ideas/havogt/dimension-generic-fields/mypy.ini ...`;
