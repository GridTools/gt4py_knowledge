---
title: "Tag and name constraints for FieldOffset, Dimension and offset providers — full catalogue"
author: egparedes
tags: [type-system, dimensions, local-dimensions, connectivities, offset-provider, unstructured, embedded, gtir, gtfn, dace, tech-debt]
created: 2026-09-17
status: draft
---

> **Appendix** to [[personal/egparedes/connectivities-as-types/connectivities-as-types|Connectivities as types]].
> A descriptive catalogue of the *string-identity* assumptions connecting
> `FieldOffset` tags, `Dimension` names and `offset_provider` keys in
...
[ADR 0026 Staggered Dimensions](https://github.com/GridTools/gt4py/blob/main/docs/development/ADRs/next/0026-Staggered_Dimensions.md),
[PR #1789](https://github.com/GridTools/gt4py/pull/1789) (the shift-path fix and its regression test).
