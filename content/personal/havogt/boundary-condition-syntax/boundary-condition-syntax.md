...
> **Appendices**:
> [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|Cross-DSL prior-art survey]] — how
...
> replay, `__prepare__`). · [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_icon4py-survey|icon4py
> concat_where survey]] — ~40 real call sites, the chained/nested idioms, and the inline
> `# TODO: Use if-else statement instead`.

> **Related (in this repo)**:
> [[personal/havogt/scan-redesign|Redesign of the vertical scan]] proposes boundary handling
...
> [[personal/havogt/field-data-protocol|FieldData protocol]] is the orthogonal **embedded
...
up in real code (see the [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_icon4py-survey|icon4py survey]],
~40 call sites):
...
The cross-DSL survey ([[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|appendix]]) confirms the
...
**The honest finding (from the [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|prior-art survey]]).**
...
quotes in the [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|research appendix]].
...
From the [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|cross-DSL survey]]:
...
- **Interaction with [[personal/havogt/scan-redesign|scan redesign]].** That note already proposes
...
- **Interaction with [[personal/havogt/field-data-protocol|FieldData protocol]].** Unbounded boundary
...
- [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_research|Cross-DSL prior-art survey]] — full,
  source-cited write-up of every framework above.
- [[personal/havogt/boundary-condition-syntax/boundary-condition-syntax_icon4py-survey|icon4py `concat_where` survey]] — the
