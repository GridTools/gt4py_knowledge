...
> **Appendices**:
> - [[personal/havogt/mesh-and-first-class-halos/mesh-and-first-class-halos_research|Prior-art survey]] — the
...
the [[personal/havogt/mesh-and-first-class-halos/mesh-and-first-class-halos_research|survey]] for sources). The
